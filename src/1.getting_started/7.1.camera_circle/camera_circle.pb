...
Procedure main()
  ...
  *surface = sdl::IMG_Load("../../../resources/textures/awesomeface.png")
  ...
  While Not window::ShouldClose()
    ...
    Protected.f radius = 10.0
    Protected.f camX   = Sin(sdl::ext_GetElapsedSeconds()) * radius
    Protected.f camZ   = Cos(sdl::ext_GetElapsedSeconds()) * radius
    
    Protected.math::vec3 eye,center,up
    math::lookAt(view,
                 math::vec3_set_float( eye, camX, 0.0, camZ), 
                 math::vec3_set_float( center, 0.0, 0.0, 0.0), 
                 math::vec3_set_float( up, 0.0, 1.0, 0.0))
