...
; CHANGES
; replace glm with math-module
; moved definition of the "transformLoc"-variable outside the render-loop
; note: because the window-aspect ratio is not 1:1, the rotation looks a little bit wired
...
Procedure main()
  ...
  *surface = sdl::IMG_Load("../../../resources/textures/awesomeface.png")
  ...
  While Not window::ShouldClose()
    ...
    math::translate_float(transform, transform,  0.5, -0.5, 0.0)
    math::rotate(transform, transform, sdl::ext_GetElapsedSeconds(), math::v3_001); math has some simple vectors predefined
