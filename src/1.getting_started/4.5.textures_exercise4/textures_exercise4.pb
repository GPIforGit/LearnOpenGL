...
; CHANGES
; add deltaTime to input process for frameindependend fading
...
Procedure main()
  ...
  *surface = sdl::IMG_Load("../../../resources/textures/awesomeface.png")
  ...
  While Not window::ShouldClose()
    ...
    shader::setFloat(ourShader, "mixValue", mixValue);
...
Procedure processInput()
  ; Time since last call (limited to 1/15 seconds)
  Protected.sdl::ext_timer delta_Timer
  Protected.d deltaTime = sdl::ext_DeltaSeconds(delta_Timer)
  ...
  If window::GetKey( sdl::#SCANCODE_UP )
    mixValue + 0.5 * DeltaTime
    If mixValue >= 1.0
      mixValue = 1.0
    EndIf
  EndIf
  ...
  If window::GetKey( sdl::#SCANCODE_DOWN )
    mixValue - 0.5 * DeltaTime
    If mixValue <= 0.0
      mixValue = 0.0
    EndIf
