...
Procedure main()
  ...
  gl::StencilFunc(GL::#NOTEQUAL, 1, $FF)
  gl::StencilOp(GL::#KEEP, GL::#KEEP, GL::#REPLACE)
  
  
  ; build and compile shaders
  ; -------------------------
  Protected.l Shader = shader::new("stencil_testing.vs", "stencil_testing.fs")
  Protected.l shaderSingleColor = shader::new("stencil_testing.vs", "stencil_single_color.fs")
  ...
  While Not window::ShouldClose()
    ...
    *view = camera::GetViewMatrix(*camera)
    ...
    shader::setMat4x4(shaderSingleColor, "view", *view)
    shader::setMat4x4(shaderSingleColor, "projection", projection)
    ...
    shader::setMat4x4(shaderSingleColor, "model", model)
    gl::DrawArrays(GL::#TRIANGLES, 0, 36)
    math::Mat4x4_set_Scalar(model, 1)
    math::translate_float(model, model, 2.0, 0.0, 0.0)
    math::scale_float(model, model, scale, scale, scale)
  ...
  shader::delete(shaderSingleColor)
