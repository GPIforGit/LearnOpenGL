...
; changes
; I moved the loadTexture()-procedure to a module texture - easier maintance
; add delete Texture
...
Procedure main()
  ...
  ; ------------------------------------
  Protected.l lightingShader = shader::new("lighting_maps.vs", "lighting_maps.fs")
  ...
  While Not window::WindowShouldClose()
    ...
    ; material properties
    shader::setVec3_float(lightingShader, "material.specular", 0.5, 0.5, 0.5 )
    shader::setFloat(lightingShader, "material.shininess", 64.0)
