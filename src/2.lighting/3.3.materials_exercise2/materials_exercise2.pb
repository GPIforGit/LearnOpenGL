...
; note this is the cyan plastic exercise
...
Procedure main()
  ...
  ; ------------------------------------
  Protected.l lightingShader = shader::new("materials.vs", "materials.fs")
  ...
  While Not window::ShouldClose()
    ...
    shader::setVec3(lightingShader, "light.position", lightPos)
    shader::setVec3(lightingShader, "viewPos", camera::GetPosition(*camera) )
    
    ; light properties
    Protected.math::vec3 lightColor
    lightColor\x = Sin( sdl::ext_GetElapsedSeconds() * 2.0 )
    lightColor\y = Sin( sdl::ext_GetElapsedSeconds() * 0.7 )
    lightColor\z = Sin( sdl::ext_GetElapsedSeconds() * 1.3 )
    Protected.math::vec3 diffuseColor, AmbientColor, tmp
    ;variant 1
    ;     math::vec3_mul_scalar( diffuseColor, lightColor, 0.5); decrease the influence
    ;     math::vec3_mul_scalar( ambientColor, diffuseColor, 0.2); low influence
    ;     shader::setVec3(lightingShader, "light.ambient", ambientColor)
    ;     shader::setVec3(lightingShader, "light.diffuse", diffuseColor)
    ;     shader::setVec3_float(lightingShader, "light.specular", 1.0, 1.0, 1.0)
    
    ;variant 2
    ;     shader::setVec3(lightingShader, "light.ambient", lightColor)
    ;     shader::setVec3(lightingShader, "light.diffuse", lightColor)
    ;     shader::setVec3_float(lightingShader, "light.specular", 1.0, 1.0, 1.0)
    
    ;variant 3
    shader::setVec3_float(lightingShader, "light.ambient", 1.0, 1.0, 1.0)
    shader::setVec3_float(lightingShader, "light.diffuse", 1.0, 1.0, 1.0)
    shader::setVec3_float(lightingShader, "light.specular", 1.0, 1.0, 1.0)
    
    ; material properties
    shader::setVec3_float(lightingShader, "material.ambient" , 0.0, 0.1, 0.06)
    shader::setVec3_float(lightingShader, "material.diffuse" , 0.0, 0.50980392, 0.50980392)
    shader::setVec3_float(lightingShader, "material.specular", 0.50196078, 0.50196078, 0.50196078)
    shader::setFloat(lightingShader, "material.shininess", 0.25 * 128)
    ...
    math::Vec3_Abs( lightColor,lightColor)   
    shader::setVec3(lightCubeShader, "LightColor", lightColor)
