...
Procedure main()
  ...
  While Not window::ShouldClose()
    ...
    shader::use(lightingShader)
    shader::setVec3(lightingShader, "light.position", camera::GetPosition(*camera))
    shader::setVec3(lightingShader, "light.direction", camera::GetFront(*camera))
    shader::setFloat(lightingShader, "light.cutOff", Cos(Radian(12.5)))
    shader::setFloat(lightingShader, "light.outerCutOff", Cos(Radian(17.5)))
        
    shader::setVec3(lightingShader, "viewPos", camera::GetPosition(*camera) )
    
    ; light properties
    shader::setVec3_float(lightingShader, "light.ambient", 0.1, 0.1, 0.1)
    ; we configure the diffuse intensity slightly higher; the right lighting conditions differ with each lighting method and environment.
    ; each environment and lighting type requires some tweaking to get the best out of your environment.        
    shader::setVec3_float(lightingShader, "light.diffuse", 0.8, 0.8, 0.8)
    shader::setVec3_float(lightingShader, "light.specular", 1.0, 1.0, 1.0)
    shader::setFloat(lightingShader, "light.constant", 1.0)
    shader::setFloat(lightingShader, "light.linear", 0.09)
    shader::setFloat(lightingShader, "light.quadratic", 0.032)
