...
; note this is the Light-Cube-Change-Exercise!
...
Procedure main()
  ...
  While Not window::WindowShouldClose()
    ...
    ; material properties
    shader::setVec3_float(lightingShader, "material.ambient" , 1.0, 0.5, 0.31)
    shader::setVec3_float(lightingShader, "material.diffuse" , 1.0, 0.5, 0.31)
    shader::setVec3_float(lightingShader, "material.specular", 0.5, 0.5, 0.5 );  specular lighting doesn't have full effect on this object's material
